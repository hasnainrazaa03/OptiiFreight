...
import { ArrowLeft, ArrowRight, Truck, Star, ShieldCheck, MapPin, Calendar, DollarSign, Award, Info } from 'lucide-react';
...
const TruckDetails: React.FC = () => {
  ...
  // Mock breakdown logic (Real app would calculate this precisely)
  const baseRate = Math.round(total * 0.85);
  const fuelSurcharge = Math.round(total * 0.10);
  const serviceFee = total - baseRate - fuelSurcharge;
                ...
                <div>
                      ...
                      <div className="flex items-center gap-2 mt-1 text-sm text-gray-600">
                        {truck.rating > 0 ? (
                           ...
                           <span className="text-blue-600 font-semibold">New Carrier</span>
                        )}
                        <span>•</span>
                        {/* REAL DATA */}
                        <span>{truck.reviews || 0} Reviews</span> 
                        <span>•</span>
                        {/* Only show Verified if true */}
                        {truck.verified && (
                ...
                <div className="mt-6 pt-6 border-t border-gray-100 grid grid-cols-2 gap-4">
                    ...
                    <div>
                      ...
                      <p className="font-medium text-green-600 flex items-center gap-1">
                        <CheckCircleIcon className="w-3 h-3"/> Verified On File
                      </p>
                    </div>
                    <div>
            ...
            <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
              ...
              <div className="relative pl-8 border-l-2 border-dashed border-gray-300 space-y-8">
                ...
                <div className="relative">
                   ...
                   <p className="text-sm text-gray-600">Est. {truck.time} Transit</p>
                </div>
              </div>
              ...
              <div className="mt-6 bg-blue-50 p-4 rounded-lg flex gap-3">
                 ...
                 <p className="text-sm text-blue-800">
                   This carrier specializes in partial loads. Your cargo ({shipmentData.weight} lbs) fits perfectly with their current route, saving you approx 30% vs standard LTL.
                 </p>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-6">
            <div className="bg-white rounded-xl shadow-lg border border-gray-100 overflow-hidden sticky top-24">
              <div className="p-6 bg-brand-dark text-white">
                <h3 className="font-heading font-bold text-lg">Price Details</h3>
              </div>
              <div className="p-6 space-y-4">
                <div className="flex justify-between text-sm">
                  <span className="text-gray-600">Base Freight Rate</span>
                  <span className="font-medium">${baseRate.toFixed(2)}</span>
                </div>
                <div className="flex justify-between text-sm">
                  <span className="text-gray-600">Fuel Surcharge (10%)</span>
                  <span className="font-medium">${fuelSurcharge.toFixed(2)}</span>
                </div>
                <div className="flex justify-between text-sm">
                  <span className="text-gray-600">OptiiFreight Service Fee</span>
                ...
                <div className="border-t border-gray-200 pt-4 mt-2">
                  ...
                  <p className="text-xs text-gray-400 text-right mt-1">Includes all taxes & fees</p>
                </div>
...
// Helper Icon for the code above
